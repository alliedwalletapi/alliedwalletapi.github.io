...
';
    ...
    $smarty = $this->context->smarty;
		...
		$smarty->assign(array(
				...
				'site_id' => $site_id,
				'currency' => $currency,
				'AlliedWalletUrl' => 'https://sale.alliedwallet.com/quickpay.aspx',
				'amount' => number_format(Tools::convertPrice($params['cart']->getOrderTotal(true, 4), $currency), 4, '.', '  '),
				...
				'total' => number_format(Tools::convertPrice($params['cart']->getOrderTotal(true, 3), $currency), 4, '.', '    '),
