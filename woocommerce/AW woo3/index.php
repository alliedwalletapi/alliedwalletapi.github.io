...
Description: AlliedWallet gateway for woocommerce, updated for woocommerce 3.2.6
Version: 3.0
Author: AlliedWallet
			...
			$allied_args = array(
				...
				if (sizeof($order->get_items())>0) : foreach ($order->get_items() as $item) :
					if ($item['qty']) :
						...
						$allied_args['ItemAmount['.$item_loop.']'] = $price;
 ...
 **/
function woocommerce_add_alliedwallet_gateway( $methods ) {
	$methods[] = 'wc-gateway-alliedwallet'; return $methods;
}
add_filter('woocommerce_payment_gateways', 'woocommerce_add_alliedwallet_gateway' );
?>