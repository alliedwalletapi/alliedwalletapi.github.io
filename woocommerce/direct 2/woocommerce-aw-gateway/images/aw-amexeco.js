jQuery(function() {
  jQuery(window).on('message onmessage', function(e) {
    ...
    if (amexeco.inline == 1) {
        ...
        jQuery.post("/wc-api/WC_AlliedWallet_Amex_Eco", 'auth_code=' + payment.auth_code +  '&transaction_id=' + payment.transaction_id + '&card_type=' + payment.card_type + '&wallet_id=' + payment.wallet_id, function(data) {
          location.href = link;
